...
return new class extends Migration {
    ...
    public function up()
    {
        Schema::create('job_posts', function (Blueprint $table) {
            ...
            $table->date('job_starting_date')->nullable();
            $table->string('job_starting_date_timestamp')->nullable();
            $table->time('job_ending_time')->nullable();
            ...
            $table->time('estimate_project_duration_time')->nullable();
            $table->string('estimate_project_duration_time_timestamp')->nullable();
            $table->tinyInteger('promotion_type')->comment('0=>featured, 1=> urgent, 2 =>pre-funded')->nullable();
